...
Der folgende Benutzer wurde vom Administrator für die Verwendung von ZARS angelegt.
 ...
 Rollen: <#list userBean.roles as role><#if role = "ROLE_USER">Benutzer<#elseif role = "ROLE_ADMIN>Administrator<#elseif role = "ROLE_ACCOUNTANT">Verrechner</#if><#if role_has_next>,</#if></#list>  
