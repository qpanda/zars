...
public interface PreferenceService {
	public void createPreference(long userId, PreferenceType preferenceType, Object value);

	public PreferenceBean findPreference(long userId, PreferenceType preferenceType);

	public void updatePreference(long userId, PreferenceType preferenceType, Object value);
}
